...
----member-----
INSERT INTO member (member_id,password,name,gender,birth,email,travel_style,country_id) VALUES('java','a','최인재','m','19950929','a@ab.c','사진','33');
...
INSERT INTO POSTCOMMENT VALUES(postcomment_seq.nextval, '1', 'spring', '지은 해물찜 맛있어요', sysdate);
INSERT INTO POSTCOMMENT VALUES(postcomment_seq.nextval, '1', 'java', '수빈 전복찜도 추천이요', sysdate);
INSERT INTO POSTCOMMENT VALUES(postcomment_seq.nextval, '1', 'mvc', '인재는 내가 찜', sysdate);
------------------------member_timeline------------------------------------
