...
INSERT INTO country VALUES('49', '독일', sysdate, 's독일어','유로');
----manager-----
INSERT INTO manager VALUES('managerKim', 'a','주커피');
----member-----
INSERT INTO member VALUES('java','a','최인재','ms','19950929','a@ab.c','사진','33');
...
INSERT INTO post VALUES(post_seq.nextval, '49', '후기', '독일 히틀러호텔 비추ㅠ', 'singleton', sysdate, 0, '독일 히틀러호텔 거르세요 베드버그 나옴 ㅠ');
----postcomment-----
