...
<!-- 
	...
	나라별 게시판 list 불러오기
 -->
<c:forEach var="ivo" items="${requestScope.list}">
<input type="hidden" name="country" value="${ivo.countryVO.countryId}"></input>	
</c:forEach>
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">${requestScope.name} 게시판</h6>
	</div>
	<div class="card-body">
